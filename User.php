    ...
    class User
    {
        ...
        public function register($nama, $username, $password)
        {
            try
            {
                ...
                $query = $this->db->prepare("INSERT INTO tbLogin(nama, username, password) VALUES(:nama, :username, :pass)");
        ...
        public function login($username, $password)
        {
            try
            {
                ...
                $query = $this->db->prepare("SELECT * FROM tbLogin WHERE username = :username");
                $query->bindParam(":username", $username);
                $query->execute();
                $data = $query->fetch();
